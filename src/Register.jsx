      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input type="text" className="mt-1 w-full rounded-lg border border-[#e9e9e9] p-2 outline-none focus:border-[#111111]" />
          </div>
          <div>
          ...
          <button className="w-full rounded-full bg-[#E60023] py-3 font-bold text-white transition hover:bg-[#ad001b]">Sign up</button>
        </form>
        <p className="mt-4 text-center text-sm text-[#767676]">
          Already have an account? <Link to="/login" className="font-bold text-[#111111] underline">Log in</Link>
        </p>
      </div>
    </div>
  )
